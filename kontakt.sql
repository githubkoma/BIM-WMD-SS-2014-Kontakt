...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 18. Jun 2014 um 13:07
...
(1, '2012-01-08', 'admin', '2012-01-08', 'admin', 'B.', 'Obama', 'US State', 'Hawai', '1956-01-08', 'obama@care.gov', '0800666666', 1),
(2, '2012-03-08', 'admin', '2013-11-07', 'user', 'H.', 'Schmidt', 'Kanzleramt', 'Kalk', '1945-01-08', 'schmidt@raucherkette.de', '', 1),
(3, '2014-03-08', 'admin', '2014-01-01', 'admin', 'W.', 'Brandt', 'Kanzleramt', 'Brunsbuettel', '1914-01-08', 'deutschland@brandt.de', '', 1),
(4, '2013-11-21', 'user', '2013-12-24', 'user', 'H.', 'Kohl', 'Kanzleramt', 'Rostock', '1948-01-08', 'schwarzkonto@kohl.de', '', 1),
(5, '2013-11-21', 'admin', '2012-05-09', 'admin', 'B.', 'Rocky', 'Box', 'Arena', '1980-01-08', 'rocky@adrian.com', '', 1),
(6, '2013-11-21', 'user', '2012-08-08', 'admin', 'B.', 'Clinton', 'US State', 'Hawana', '1961-01-08', 'clinton@practice.gov', '', 1),
(7, '2013-11-21', 'admin', '2014-02-08', 'admin', 'G.', 'Bush', 'US State', 'Teheran', '1983-01-08', 'bush@standard-oil.gov', '', 1);
